<div id="homcontainer">
    <div id="homeimg" style="background-image: url(<?= $this->getURL("images/banner-home-en.png") ?>);">
        ...
        <div id="hometxt2">Design your<br/>FB Fan Page <span style="color:#ff0000">FREE</span></div>
        <span id="hometxt3">Visit us in <a href="http://www.facebook.com/online.conexion" target="_blank"><img src="<?= $this->getURL("images/free-facebook-fan-page-creator.png") ?>" alt="Free Facebook Fan Page Creator"/></a>&nbsp;<a target="blank" href="http://www.twitter.com/FbConexion"><img src="<?=$this->getURL("images/1327961836_twitter.png")?>"/></a></span>
    </div>
    <div id="hometxt4">
        <p>
