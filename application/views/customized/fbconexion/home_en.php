    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            contactodesign=function(){
                $("#bd2cont").dialog({
                    title:"Facebook Fan Page Design Services",
                    modal:true,
                    width:280,
                    buttons:{
                        "OK":function(){
        ...
        <div id="wrapper">
            ...
            <div class="fbcuadroazul" id="cuadro1" style="text-align: center;">
                <div style="margin-bottom: 10px;">
                    The partner that <strong style="font-size: 24px">helps you</strong> turn simple <br/>
                    conversations into <strong style="font-size: 16px">social experiences</strong>.<br/>
                </div>
                <div onclick="return contactodesign()" style="background:url(http://www.fbconexion.com/images/bannerdesignfanpage_en.jpg) bottom no-repeat" id="linkdesign"></div>
                <div id="pruebagratis">
                    Design your<br/>FB Fan Page FREE
                </div>
                <div>
                    <strong style="font-size: 24px">Try our platform</strong> the PERFECT tool to optimize<br/>
                    <strong style="font-size: 16px">your social media</strong> plan on <strong style="font-size: 20px">Facebook</strong>.
                </div>
            </div>
            <div id="btnfacebook">
                Start Now to Customize your Facebook Fan Page
            </div>
            ...
            <div class="fbcuadroazul" id="cuadro2">
                ...
                <div style="text-align: center;"><a href="#" style="color:#fff; font-size: 13px; line-height: 25px;">Check reviews</a></div>
            </div>
            ...
            <a href="http://www.fbconexion.com/blog/es/" target="_PARENT" id="btnblog"><img src="<?= $this->getURL("images/fpgotoblog_en.png") ?>" id=""/></a>
            ...
            <div class="fbcuadroazul" id="cuadro3" style="margin-bottom: 120px;">
                <div id="txtencuentra">
                    Check what our Users are doing with FbConexion
                </div>
                <div id="cuadrobuscar">
                ...
                <div class="listadopaginas">
                    ...
                    <div style="display: block; text-align: center;">
                        <a href="2" style="color:#fff;" id="linkvermaspag">See more</a>
                    </div>
                </div>
            </div>
            <script type="text/javascript">
