<div id="homcontainer">
    <div id="homeimg" style="background-image: url(<?= $this->getURL("images/banner-home-es.png") ?>);">
        ...
        <div id="hometxt2">Prueba nuestra plataforma GRATIS</div>
        <a id="hometxt3" href="http://www.facebook.com/pages/FB-Conexion-Latinoamerica/285369954810369" target="_blank">&nbsp;<br/>Visítanos en <img src="<?= $this->getURL("images/free-facebook-fan-page-creator.png") ?>" alt="Facebook"/></a>
    </div>
    <div id="hometxt4">
        <p>
